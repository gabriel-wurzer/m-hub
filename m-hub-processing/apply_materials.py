...
# Innenwand-Laufmeter je NETTO-m2 Geschossflaeche (Wolfgang Q7, Mittelwerte je Periode;
# "netto" = ohne Aussenwand). tragend = Kaminwand + Wohnungstrennwand; leicht = nicht-tragend.
